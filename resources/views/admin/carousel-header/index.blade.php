            ...
            <div class="col-sm-auto bg-bar sticky-md-top sticky-bottom bottom-0 order-last order-md-first p-0">
                <div class="d-flex flex-sm-column flex-row flex-nowrap bg-bar align-items-center sticky-top">
                    ...
                    <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mx-auto text-center align-items-center">
                        ...
                        <li>
                            <a href="/header/index" class="nav-link active py-3 px-2" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Headers">
                ...
                <div class="container-fluid px-5 py-3">
                    ...
                    <form action="{{ route('header.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    <div class="card-header py-3">
                                        <div class="hstack align-items-end justify-content-between">
                                            <div>
                                                <label for="Image" class="form-label visually-hidden">Header 1</label>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">  
                                            <div>
                                                <img id="frame1" src="{{ asset('asset-carousel/'. $header1->gambar) }}" class="img-fluid" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card">
                                    <div class="card-header py-3">
                                        <div class="hstack align-items-end justify-content-between">
                                            <div>
                                                <label for="Image" class="form-label visually-hidden">Header 2</label>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">  
                                            <div>
                                                <img id="frame2" src="{{ asset('asset-carousel/'. $header2->gambar) }}" class="img-fluid" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card">
                                    <div class="card-header py-3">
                                        <div class="hstack align-items-end justify-content-between">
                                            <div>
                                                <label for="Image" class="form-label visually-hidden"> Header 3</label>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">  
                                            <div class="justify-content-center align-items-center">
                                                <img id="frame3" src="{{ asset('asset-carousel/'. $header3->gambar) }}" class="img-fluid" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <!-- Some Decor to Make ur Day! -->
                            <div class="col-md-6"> 
                                <div class="p-3">
                                    <img src="/asset-img/Person-Garden.jpg" class="img-fluid">
                                </div>  
                            </div>
