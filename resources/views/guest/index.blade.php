            ...
            <div class="container">
                <div id="slider-header" class="carousel slide" data-bs-ride="true">
                    <div class="carousel-indicators">
                        ...
                        <button type="button" data-bs-target="#slider-header" data-bs-slide-to="1" aria-label="Slide 2"></button>
                        <button type="button" data-bs-target="#slider-header" data-bs-slide-to="2" aria-label="Slide 3"></button>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                        <img src="asset-carousel/header.png" class="d-block w-100" alt="header">
                        </div>
                        <div class="carousel-item">
                        <img src="asset-carousel/infografis-1.png" class="d-block w-100" alt="infografis-1">
                        </div>
                        <div class="carousel-item">
                        <img src="asset-carousel/infografis-2.png" class="d-block w-100" alt="infografis-2">
                        </div>
                    </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body p-4">
                        ...
                        penggunaan plastik sekali pakai dan meningkatkan kesadaran masyarakat akan pentingnya 
                        menggunakan barang yang eco friendly atau barang yang ramah lingkungan sebagai pengganti 
                        dari plastik. Dengan adanya gerakan ini kami harap dapat berkontribusi untuk indonesia 
                        sebagai gerakan yang efektif dalam mengedukasi masyarakat untuk beralih menggunakan barang 
        ...
        <div class="container slide-article">
            ...
            <div id="sliderSmallScreen" class="carousel slide d-sm-none" data-bs-ride="true">
                <div class="carousel-inner">
                    ...
                    @foreach ($artikelActivecl as $item)
                    <div class="carousel-item">
                        <div class="d-flex">
                            <div class="card m-2">
                                <img src="{{ asset('asset-article/'. $item->gambar) }}" class="card-img-top" alt="header-web">
                ...
                <button class="carousel-control-next" type="button" data-bs-target="#sliderSmallScreen" data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                </button>
            </div>
                    ...
                    <div class="col-md-6 mb-3" id="berlangganan">
                        <form class="rounded-4 p-4 form-footer" action="#" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control rounded-3" id="userEmail" placeholder="name@example.com"> 
